  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">ECM开发平台</a>
        <a class="site-navbar__brand-mini" href="javascript:;">ECM</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        <el-menu-item index="2">
          <el-badge value="hot">
            <a href="//www.szcxsl.com/" target="_blank">联系我们</a>
          </el-badge>
        </el-menu-item>
        <el-submenu index="3">
